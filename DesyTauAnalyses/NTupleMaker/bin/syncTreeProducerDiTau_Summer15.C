...
void synchNtuple(string sample = "GGFH125", string stream = "MuTau", bool incl=false) {
  ...
  TTree *lOTree = new TTree("tree","tree");
   ...
   float idecayModeFinding1   ; tree->SetBranchAddress("decayModeFindingL1",   &idecayModeFinding1 );
   float idecayModeFindingNewDM1  ; tree->SetBranchAddress("decayModeFindingNewDML1",  &idecayModeFindingNewDM1 );
   float itightestAntiEMVA5WP1   ; tree->SetBranchAddress("tightestAntiEMVA5WPL1",  &itightestAntiEMVA5WP1 );
   float itightestAntiMu3WP1     ; tree->SetBranchAddress("tightestAntiMu3WPL1",   &itightestAntiMu3WP1 );
   ...
   float idecayModeFinding2   ; tree->SetBranchAddress("decayModeFindingL2",   &idecayModeFinding2 );
   float idecayModeFindingNewDM2  ; tree->SetBranchAddress("decayModeFindingNewDML2",  &idecayModeFindingNewDM2);
   float itightestAntiEMVA5WP2  ; tree->SetBranchAddress("tightestAntiEMVA5WPL2",  &itightestAntiEMVA5WP2 );
   float itightestAntiMu3WP2   ; tree->SetBranchAddress("tightestAntiMu3WPL2",   &itightestAntiMu3WP2 );
